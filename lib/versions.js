        ...
        if (err) {
            ...
            versions.forEach(function(version){
                validationPromises.push(new Promise(function(resolve, reject){
                    ...
                    request.head(resolveUrl(url, module.exports.getVersionNames({
                        version: version
                    }).platforms.win32), function(err, res) {
...
module.exports = {
    ...
    getVersionNames: function(params) {
        var versionNames = {
        ...
        var templateData = {
            version: params.version,
            name: params.customName ? params.customName : semver.satisfies(params.version, '>=0.12.0 || ~0.12.0-alpha') ? 'nwjs' : 'node-webkit'
        };
